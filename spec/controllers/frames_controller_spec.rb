...
RSpec.describe FramesController, type: :controller do
  ...
  let(:valid_attributes) {
    { frame: 1, first: 7, second: 3}
  }

let(:game) {FactoryGirl.create(:game)}
  let(:invalid_attributes) {
    {frame: 'first', first: 7, second: 3}
  }
  ...
  describe "GET #index" do
    it "assigns all frames as @frames" do
      frame = Frame.new valid_attributes
      second_frame = Frame.create! valid_attributes
      frame.game = game
      frame.save
      get :index, {game_id: game.id}, valid_session
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved frame as @frame" do
        post :create, {:frame => invalid_attributes, game_id: game.id}, valid_session
        expect(assigns(:frame)).to be_a_new(Frame)
      end
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the frame as @frame" do
        frame = Frame.create! valid_attributes
        put :update, {:id => frame.to_param, :frame => invalid_attributes}, valid_session
        expect(assigns(:frame)).to eq(frame)
      end
